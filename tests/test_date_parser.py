...
class TestDateParser(BaseTestCase):
    ...
    @parameterized.expand(
        [
            ...
            param("We", datetime(2012, 11, 7)),
            param("Th", datetime(2012, 11, 8)),
            param("Fr", datetime(2012, 11, 9)),
            param("Sa", datetime(2012, 11, 10)),
            param("Su", datetime(2012, 11, 11)),
            param("Mo", datetime(2012, 11, 12)),
            param("Tu", datetime(2012, 11, 13)),
